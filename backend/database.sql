...
CREATE TABLE IF NOT EXISTS products (
    ...
    kategori_id INTEGER REFERENCES categories(id) ON DELETE
    SET NULL,
...
-- =============================================
INSERT INTO categories (nama, deskripsi, icon)
VALUES (
        'Elektronik',
        'Laptop, HP, charger, dan perangkat elektronik lainnya',
        'bi-laptop'
    ),
    (
        'Buku & Alat Tulis',
        'Buku kuliah, novel, alat tulis, dan perlengkapan belajar',
        'bi-book'
    ),
    (
        'Pakaian',
        'Baju, celana, jaket, sepatu, dan aksesoris fashion',
        'bi-bag'
    ),
    (
        'Kos & Furniture',
        'Peralatan kos, furniture, kasur, dan perlengkapan kamar',
        'bi-house'
    ),
    (
        'Olahraga',
        'Alat olahraga, sepatu olahraga, dan perlengkapan gym',
        'bi-trophy'
    ),
    (
        'Kendaraan',
        'Sepeda, motor, helm, dan aksesoris kendaraan',
        'bi-bicycle'
    ),
    (
        'Makanan & Minuman',
        'Snack, minuman, dan makanan ringan',
        'bi-cup-straw'
    ),
    (
        'Lainnya',
        'Barang-barang lainnya yang tidak masuk kategori di atas',
        'bi-three-dots'
    );
