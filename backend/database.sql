...
-- =============================================
INSERT INTO users (nama, email, password, no_telepon, role) VALUES
('Administrator', 'admin@kampus.ac.id', '$2b$10$YourHashedPasswordHere', '081234567890', 'admin');

-- Note: The hashed password above is a placeholder.
-- The actual hash will be generated by the backend seeder script.
